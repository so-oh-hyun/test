...
def generate_travel_plan(city, client):
    ...
    - 블루 모스크 내부의 멋진 타일과 아치형 구조를 감상하며 걸어 보세요. 무료 입장이 가능합니다.
    ...
    - 점심 후에는 갈라타 다리 근처에서 강가를 따라 산책하며 도시의 풍경을 만끽하세요.

    3.저녁:
    - 저녁에는 보스포루스 해협 유람선을 타고 도시의 아름다운 야경을 감상하세요. 해가 질 때 풍경은 특히 장관입니다.
    - 유람선 투어 후, 이슬람 문화의 향기를 느낄 수 있는 근처의 레스토랑에서 저녁 식사를 즐기세요.
    - 현지인들이 추천하는 터키식 케밥이나 메제 플래터를 주문해 보세요. 맛있는 음식과 함께하는 시간이 될 것입니다.
    - 저녁 식사 후에는 타흐탸르 거리에서 산책하며 이스탄불의 밤문화와 분위기를 느껴 보세요.
